    ...
    if($result[ ($row_len*$i)-1 + ($option_page-1)*($row_len*$photo_in_one_page)-1])
    {
        ...
        print <<__html_file__;
                    <td width="140">
                        ...
                        <div style="margin-left:auto; margin-right:auto; margin-top:0px; height:100px; width:100px">
                            <a href="$img_src">
                            <img title="$title" src="$shortcut_src" style="max-height:100%; max-width:100%;"/>
                            </a>
                        </div>
                        <div style="word-wrap:break-word; text-align:center; width:140px; margin-left:auto; margin-right:auto; margin-top:20px">
                            <br/>$photo_name
                        </div>
                    </td>
__html_file__
